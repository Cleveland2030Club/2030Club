Feature: Login Users
  ...
  Scenario: User should be able to successfully log in
    Given the following user records in the data store
      ...
      And I fill in "Password" with "password"
    When I press "Log In"
    Then I should see "jdoe@gmail.com"

  Scenario: Not-activated user should be redirected to New Payment after login
    Given I have a user with the email "jdoe@gmail.com" in the data store
      And "jdoe@gmail.com" is not activated
    When I log in with "jdoe@gmail.com"
    Then I should be on the new order page
     And I should see "Member Registration"

  Scenario: User login name should be displayed on the home page after user logged in
    Given the following user records in the data store
      | first_name | last_name | email | password |
      | Jane | Smith | jsmith@gmail.com | password |
      And I am on the user login page
      And I fill in "Email" with "jsmith@gmail.com"
      And I fill in "Password" with "password"
      And I press "Log In"
