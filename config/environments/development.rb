...
config.gem "factory_girl", :lib => "factory_girl", :version => '2.0.5', :source => "http://gems.github.com" unless File.directory?(File.join(Rails.root, "vendor/plugins/factory_girl"))
